...
export class WallpaperListingComponent implements OnInit
{
    ...
    loadWallpapers()
    {
        ...
        item.url = "./src/main/ts/assets/images/cloth/topik/58.png";
        item.title = "Flut1";
        wallpapers.push(item);

        let item2 = new Wallpaper();
        item2.url = "./src/main/ts/assets/images/cloth/topik/59.png";
        item2.title = "Flut2";
        wallpapers.push(item2);

        let item3 = new Wallpaper();
        item3.url = "./src/main/ts/assets/images/cloth/topik/60.png";
        item3.title = "Flut1";
        wallpapers.push(item3);

        let item4 = new Wallpaper();
        item4.url = "./src/main/ts/assets/images/cloth/topik/61.png";
        item4.title = "Flut2";
        wallpapers.push(item4);

        let item5 = new Wallpaper();
        item5.url = "./src/main/ts/assets/images/cloth/topik/62.png";
        item5.title = "Flut1";
        wallpapers.push(item5);

        let item6 = new Wallpaper();
        item6.url = "./src/main/ts/assets/images/cloth/topik/63.png";
        item6.title = "Flut2";
    ...
    loadBottom()
    {
        ...
        let item = new Wallpaper();
        item.url = "./src/main/ts/assets/images/cloth/niz/42.png";
        item.title = "Flut1";
        wallpapers.push(item);

        let item2 = new Wallpaper();
        item2.url = "./src/main/ts/assets/images/cloth/niz/43.png";
        item2.title = "Flut2";
        wallpapers.push(item2);

        let item3 = new Wallpaper();
        item3.url = "./src/main/ts/assets/images/cloth/niz/44.png";
        item3.title = "Flut2";
        wallpapers.push(item3);

        let item4 = new Wallpaper();
        item4.url = "./src/main/ts/assets/images/cloth/niz/45.png";
        item4.title = "Flut2";
        wallpapers.push(item4);

        let item5 = new Wallpaper();
        item5.url = "./src/main/ts/assets/images/cloth/niz/46.png";
        item5.title = "Flut2";
        wallpapers.push(item5);
    ...
    loadDresses()
    {
        ...
        let item = new Wallpaper();
        item.url = "./src/main/ts/assets/images/cloth/dresses/2.png";
        item.title = "Flut1";
        wallpapers.push(item);

        let item2 = new Wallpaper();
        item2.url = "./src/main/ts/assets/images/cloth/dresses/3.png";
        item2.title = "Flut2";
        wallpapers.push(item2);

        let item3 = new Wallpaper();
        item3.url = "./src/main/ts/assets/images/cloth/dresses/4.png";
        item3.title = "Flut2";
        wallpapers.push(item3);

        let item4 = new Wallpaper();
        item4.url = "./src/main/ts/assets/images/cloth/dresses/5.png";
        item4.title = "Flut2";
        wallpapers.push(item4);

        let item5 = new Wallpaper();
        item5.url = "./src/main/ts/assets/images/cloth/dresses/6.png";
        item5.title = "Flut2";
        wallpapers.push(item5);
